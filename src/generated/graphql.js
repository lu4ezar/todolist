...
export type TodoResolvers<ContextType = any, ParentType = $ElementType<ResolversParentTypes, 'Todo'>> = {
  ...
  priority?: Resolver<?$ElementType<ResolversTypes, 'TodoPriority'>, ParentType, ContextType>,
  status?: Resolver<?$ElementType<ResolversTypes, 'TodoStatus'>, ParentType, ContextType>,
...
export type QueryResolvers<ContextType = any, ParentType = $ElementType<ResolversParentTypes, 'Query'>> = {
  todo?: Resolver<?$ElementType<ResolversTypes, 'Todo'>, ParentType, ContextType, $RequireFields<QueryTodoArgs, { id: * }>>,
...
export type MutationResolvers<ContextType = any, ParentType = $ElementType<ResolversParentTypes, 'Mutation'>> = {
  createTodo?: Resolver<$ElementType<ResolversTypes, 'Todo'>, ParentType, ContextType, $RequireFields<MutationCreateTodoArgs, { input: * }>>,
  updateTodo?: Resolver<$ElementType<ResolversTypes, 'Todo'>, ParentType, ContextType, $RequireFields<MutationUpdateTodoArgs, { id: *, input: * }>>,
  deleteTodo?: Resolver<$ElementType<ResolversTypes, 'Todo'>, ParentType, ContextType, $RequireFields<MutationDeleteTodoArgs, { id: * }>>,
};
